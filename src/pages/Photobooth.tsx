      ...
      <div className="container max-w-6xl mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="text-muted-foreground font-serif-italic">
            Capture beautiful moments with fun filters and templates, Anushka!
          </p>
        </motion.div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  {templates.map((template) => (
                    <button
                      ...
                      className={`px-4 py-3 rounded-lg text-sm transition-all border-2 ${currentTemplate === template.id
                ...
                <div className="flex flex-wrap gap-2">
                  {filters.map((filter) => (
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg text-sm transition-all ${currentFilter === filter.value
