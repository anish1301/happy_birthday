        ...
        >
          <div className="text-center space-y-4">
            ...
            <p className="text-foreground/90 leading-relaxed text-sm italic px-2">
              'It's your 22nd Birthday today, I really wanted to give you a handwritten letter
              but I guess as a developer this is only what I can give you❤️
              I hope you like this letter also!'
            </p>
