...
const memories = [
  {
    id: 1,
    image: "/Anushka/1.png.jpeg",
    caption: "Ahhh such a cutie !",
    description: "Imagine having a rough day but you have a girl like this ",
  },
  {
    id: 2,
    image: "/Anushka/2.png.jpeg",
    caption: "The Iconic dress!!",
    description: "In this Dress you felt real to me after the long waiittttt of 8 months (15th Nov, 3.47pm btw) ",
  },
  {
    id: 3,
    image: "/Anushka/3.png.jpeg",
    caption: "My Girl",
    description: "Always love the fact that you are so effortlessly pretty and also you are more comfortable than me .",
  },
  {
    id: 4,
    image: "/Anushka/4.png.jpeg",
    caption: "That Look...",
    description: "syallleeee ( ek mard ko dabate hue anushka thakur ) ",
  },
  {
    id: 5,
    image: "/Anushka/5.png.jpeg",
    caption: "Babby",
    description: "I miss you so much , life was good back then ( 2022) ",
  },
  {
    id: 6,
    image: "/Anushka/6.png.jpeg",
    caption: "Ragebait Successful",
    description: "Ummmm don't take ragebait seriouslyyyy"
  },
  {
    id: 7,
    image: "/Anushka/8.png.jpeg",
    caption: "The Face which i fall in love with",
    description: "I'm always gonna love the way u smile",
  },
  {
    id: 8,
    image: "/Anushka/9.png.jpeg",
    caption: "Ufff , My wifeyy",
    description: "What can a mere mortal like me comment on HER",
  }
];
  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-3/5">
        <motion.div
          className="aspect-square rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.1)] border-x-8 border-y-[6px] border-white group relative bg-black/5"
    ...
    <div className="min-h-screen gradient-romantic relative overflow-x-hidden">
      ...
      >
        ...
        <p className="text-xl md:text-2xl text-muted-foreground font-serif-italic leading-relaxed px-4">
          ...
          i keep on complimenting u because ur pretty as hell... <br />
